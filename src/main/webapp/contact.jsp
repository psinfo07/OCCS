...
<div id="wrapper">
					...
					<div class="row">
						<div class="col-md-6">
							<ul class="topleft-info">
								<li><i class="fa fa-phone"></i> +91 9020943344</li>
							</ul>
						</div>
						<div class="col-md-6">
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
							<a href="index.jsp" class="dropdown-toggle" data-delay="0" data-close-others="false">Home</a>
                            </li>
                        <li class="dropdown">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					<li><a href="contact.html"><i class="fa fa-home"></i></a><i class="icon-angle-right"></i></li>
	...
	<section id="content">
	<div class="map">
		<div id="google-map" data-latitude="10.0461° N" data-longitude="76.3259° E"></div>
	</div>
	<div class="container">
		<div class="row">
